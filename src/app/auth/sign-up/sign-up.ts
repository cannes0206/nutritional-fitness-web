...
export abstract class SignUpFormItems {
  ...
  static weightMeasurement: FormItem = { controlName: 'startWeight', label: 'Weight', required: true };
  static startHeight: FormItem = { controlName: 'startHeight', label: 'Height', required: true };
  static heightMeasurement: FormItem = { controlName: 'heightMeasurement', label: '', required: true };
